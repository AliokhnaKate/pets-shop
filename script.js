...
searchButton.addEventListener('click', function() {
    ...
    function filter(value) {
        //Тут value - это не длина массива, но такая проверка тоже возможна, по факту тут написано [] == 0 (если массив пустой). массив [] преобразуется в примитив с целью сравнения и становится пустой строкой , получается '' == 0, затем пустая строка преобразовывается в число и становится 0. получается 0 == 0 и это true
        if (value == 0) {
            shopItems.innerHTML = '';
